    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="activityModalLabel{{ $actividad->id }}">Detalles de la
                    Actividad #{{ $actividad->id }}</h5>
            ...
            <div class="modal-body">
                <div class="detalles-body">
                    <p>(<strong>{{ $usuario->username }}</strong>#{{ $usuario->id }}) | {{ $actividad->nombre }}
                        a las {{ $actividad->created_at->format('H:i') }} del día
